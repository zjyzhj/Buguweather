...
import com.qy.buguweather.gson.Forecast;
import com.qy.buguweather.gson.Weather;
import com.qy.buguweather.service.AutoUpdateService;
import com.qy.buguweather.util.HttpUtil;
import com.qy.buguweather.util.Utility;
...
// 初始化各控件
        ...
        navButton.setBackgroundResource(R.drawable.ic_home);
...
// 无缓存时去服务器查询天气
    ...
    /**
     * 加载必应每日一图  https://blog.csdn.net/qq_64175477/article/details/134250051
     */
    ...
    public void requestWeather(final String weatherId) {
        ...
        String weatherUrl = "http://guolin.tech/api/weather?cityid=" +
                weatherId + "&key=b43855e7b838405e91fd63d192870fd4";
